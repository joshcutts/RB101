...
---
Don't need a data structure. Can just use the times method
...
define a method that takes string and number as inputs (assume the inputs are correct)
use times method to print the given string the given integer number of times
end the method
